...
contract Verifier is IVerifier {
    ...
    function verify(bytes memory proof, bytes32 inputHash) external override returns (bool) {
        uint256 riskScore = uint256(inputHash);
        // Delegate to mock logic for demo
        return verifyMockProof(proof, riskScore);
    }
